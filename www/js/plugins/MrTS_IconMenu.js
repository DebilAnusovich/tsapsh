...
(function() {
	...
	var descriptionList = {
		...
		'item': ["", "\\I[210] NHBENTAP."],
		'skill': ["", "\\I[76] CKNJLIbI."],
		'equip': ["", "\\I[153] EKNIIEPOBKA."],
		'status': ["", "\\I[193] CTATYC."],
		'formation': ["", "\\I[82] IIOCNPOYKA."],
           'achievements': ["", "\\I[302] JIOCTN>I<EHNR."],
		'options': ["", "\\I[80] Настройки Игры."],
		'save': ["", "\\I[79] SAFE."],
           'quest': ["", "\\I[234] Квестовый журнал."],
		'gameEnd': ["", "\\I[1945] Выход."] 
	};
	/* --------------------------------------------------------------------------------
